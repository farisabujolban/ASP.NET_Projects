...
namespace SchoolManagementApp.MVC.Controllers
{
    public class CoursesController : Controller
    {
        ...
        // GET: Courses
        /*
        An expanded form of the "public async Task<IActionResult> Index()" component or method
        ...
        */
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Name,Code,Credits")] Course course)//removed the Id just so the user is not 
        {                                                                                       //allowed to change the Id while editing the
            if (id != course.Id)                                                                //course since the program is trying to find
            {                                                                                   //if the id requested is avaliable to edit
                return NotFound();
            }
